...
public class fiche_genie extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fiche_genie);
        ...
        NIV0.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EditText speed =(EditText) findViewById(R.id.ETSpeed);
                EditText stamina =(EditText) findViewById(R.id.ETStamina);
                //Drawable nivo0= getResources().getDrawable(R.drawable.genienv0);
        ...
        NIV1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EditText speed =(EditText) findViewById(R.id.ETSpeed);
                EditText stamina =(EditText) findViewById(R.id.ETStamina);
                /*Drawable nivo1= getResources().getDrawable(R.drawable.genienv1);
        ...
        NIV2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EditText speed =(EditText) findViewById(R.id.ETSpeed);
                EditText stamina =(EditText) findViewById(R.id.ETStamina);
               /* Drawable nivo2= getResources().getDrawable(R.drawable.genienv2);
        ...
        NIV3.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                EditText speed =(EditText) findViewById(R.id.ETSpeed);
                EditText stamina =(EditText) findViewById(R.id.ETStamina);
                /*Drawable nivo3= getResources().getDrawable(R.drawable.genienv3);
